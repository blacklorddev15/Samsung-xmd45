...
const sections = [
  ...
  },
  {
    title: 'Support',
    links: [
      { label: 'Telegram Support', href: 'https://t.me/blacklordtech', external: true },
      { label: 'WhatsApp', href: 'https://wa.me/254108595201', external: true },
      { label: 'Email Us', href: 'mailto:support@blacklord.tech', external: true },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-5" style={{ color: '#475569' }}>
              Kenya's trusted provider of Pterodactyl panel hosting, Telegram automation bots, and tech solutions.
            </p>
            {/* Social / contact chips */}
            <div className="flex flex-wrap gap-2">
              {[
                { label: 'Telegram', href: 'https://t.me/blacklordtech', icon: '✈️' },
          ...
          {sections.map(s => (
            <div key={s.title}>
              <p className="text-xs font-bold uppercase tracking-widest mb-4" style={{ color: '#7c3aed' }}>{s.title}</p>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 rounded-xl mb-8"
          ...
          <p className="text-xs leading-relaxed" style={{ color: '#475569' }}>
            <span className="font-semibold" style={{ color: '#c084fc' }}>Panel Warranty: </span>
            Pterodactyl panel replacement warranty is valid for <strong style={{ color: '#c084fc' }}>2 weeks</strong> from purchase. Contact support within this period for a free replacement.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-8"
          ...
          <p className="text-xs text-center sm:text-left" style={{ color: '#374151' }}>
            © {new Date().getFullYear()} Blacklord Tech Inc. All rights reserved.
          </p>
